...
public class Track9 extends AppCompatActivity {
...
//        Toast.makeText(this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    public void saveMap(Map<String, Boolean> inputMap) {
        SharedPreferences pSharedPref = getApplicationContext().getSharedPreferences("progress_9", Context.MODE_PRIVATE);
        if (pSharedPref != null) {
            JSONObject jsonObject = new JSONObject(inputMap);
            String jsonString = jsonObject.toString();
            SharedPreferences.Editor editor = pSharedPref.edit();
            editor.remove("Track_9").commit();
            editor.putString("Track_9", jsonString);
            editor.commit();
        }
    }
    ...
    public Map<String, Boolean> loadMap() {
        ...
        try {
            if (pSharedPref != null) {
                String jsonString = pSharedPref.getString("Track_9", (new JSONObject()).toString());
