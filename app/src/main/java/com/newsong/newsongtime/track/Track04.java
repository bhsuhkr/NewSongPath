...
public class Track04 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.track_4);
...
//        Toast.makeText(this, "저장되었습니다.", Toast.LENGTH_SHORT).show();
    ...
    public void saveMap(Map<String, Boolean> inputMap) {
        SharedPreferences pSharedPref = getApplicationContext().getSharedPreferences("progress_04", Context.MODE_PRIVATE);
        if (pSharedPref != null) {
            JSONObject jsonObject = new JSONObject(inputMap);
            String jsonString = jsonObject.toString();
            SharedPreferences.Editor editor = pSharedPref.edit();
            editor.remove("Track_04").commit();
            editor.putString("Track_04", jsonString);
            editor.commit();
        }
    }
    ...
    public Map<String, Boolean> loadMap() {
        ...
        try {
            if (pSharedPref != null) {
                String jsonString = pSharedPref.getString("Track_04", (new JSONObject()).toString());
