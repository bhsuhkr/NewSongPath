...
public class Track11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playersRef = rootRef.child("Track").child(androidId).child("November");
    ...
    public void saveMap(Map<String, Boolean> inputMap) {
        ...
        if (pSharedPref != null) {
            ...
            editor.remove("Track_11").commit();
            editor.putString("Track_11", jsonString);
            editor.commit();
        }
    }
    ...
    public void loadMap() {
        ...
        try {
            if (pSharedPref != null) {
                String jsonString = pSharedPref.getString("Track_11", (new JSONObject()).toString());
